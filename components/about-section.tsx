    ...
    <section id="about" className="py-24 lg:py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="glass rounded-3xl p-8 lg:p-12 mb-16">
            <div className="grid lg:grid-cols-5 gap-8 items-center">
              ...
              <div className="lg:col-span-2 flex justify-center">
                <motion.div
                  className="relative h-56 w-56 lg:h-64 lg:w-64"
                  animate={{ rotate: 360 }}
                  transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                >
                  <div className="absolute inset-0 rounded-full border-2 border-dashed border-purple-500/30" />
                  <div className="absolute inset-5 rounded-full border-2 border-dashed border-blue-500/30" style={{ animationDirection: "reverse" }} />
                  <div className="absolute inset-8 overflow-hidden rounded-full border-[6px] border-neutral-950 bg-white shadow-lg shadow-black/20">
                    <Image
                      src="/icon.png"
                      alt="NJ Marcelo mark"
                      fill
          ...
          {/* Tech Stack */}
          <motion.div variants={itemVariants} className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden py-3">
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
              ...
              <h3 className="relative text-lg sm:text-xl font-semibold text-center mb-5">
                Technologies I Work With
              </h3>

              <div className="tech-marquee relative overflow-hidden rounded-2xl border border-white/10 py-3 shadow-2xl shadow-purple-950/15">
                <div className="tech-marquee-stream relative h-28 overflow-hidden sm:h-32">
                  <div className="tech-marquee-track inline-flex min-w-max items-center will-change-transform">
                    {[0, 1].map((setIndex) => (
                      <div
                        key={setIndex}
                      ...
                      >
                        {techStack.map((tech, index) => (
                          <div
                            ...
                            className="tech-card h-20 w-28 shrink-0 sm:h-24 sm:w-32"
                          >
                            <div
                              className="tech-card-float h-full w-full"
                              style={{ animationDelay: `${index * -0.35}s` }}
                            >
                              <div className="tech-card-surface group relative flex h-full w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-xl border border-purple-400/15 bg-gradient-to-br from-white/[0.09] via-slate-950/70 to-blue-950/30 p-3 shadow-lg shadow-blue-950/20 transition-all duration-300 hover:z-20 hover:-translate-y-1 hover:scale-105 hover:border-blue-300/45 hover:shadow-blue-500/25">
                                ...
                                <span className="relative text-center text-xs font-semibold text-foreground/80 transition-colors duration-300 group-hover:text-foreground sm:text-sm">
                                  {tech.name}
                                </span>
                              </div>
                            </div>
              ...
              <div className="relative mx-auto mt-5 flex max-w-4xl flex-wrap items-center justify-center gap-2">
                {techStack.map((tech) => (
                  <span
                    key={tech.name}
                    className="rounded-full border border-blue-300/15 bg-white/[0.03] px-3 py-1 text-xs font-medium text-muted-foreground shadow-[0_0_16px_rgba(59,130,246,0.08)] transition-all duration-300 hover:border-purple-300/40 hover:bg-purple-500/10 hover:text-foreground hover:shadow-[0_0_18px_rgba(168,85,247,0.18)]"
                  >
                    {tech.name}
                  </span>
                ))}
